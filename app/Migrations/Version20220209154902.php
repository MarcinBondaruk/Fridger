...
final class Version20220209154902 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("CREATE TABLE IF NOT EXISTS recipe_ingredient (ingredient_id INT NOT NULL, recipe_id CHAR(36) NOT NULL), amount INT NOT NULL, PRIMARY KEY(ingredient_id, recipe_id)");
        $this->addSql("CREATE TABLE IF NOT EXISTS recipe_tag (tag_id INT NOT NULL, recipe_id CHAR(36) NOT NULL), PRIMARY KEY(tag_id, recipe_id)");
